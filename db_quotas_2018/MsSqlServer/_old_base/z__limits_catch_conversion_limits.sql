...
/****** Object:  Table [dbo].[z__limits_catch_conversion_limits]    Script Date: 07.04.2017 13:19:47 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[z__limits_catch_conversion_limits](
	[id] [int] NOT NULL,
	[year_from] [int] NULL,
	[year_to] [int] NULL,
 ...
 CONSTRAINT [PK_z__limits_catch_conversion_limits] PRIMARY KEY CLUSTERED 
(
	[id] ASC
